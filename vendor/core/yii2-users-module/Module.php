...
class Module extends \yii\base\Module
{
     ...
     * @inheritdoc
     */
    public $controllerNamespace = 'core\users\controllers\frontend';
    ...
    public function init()
    {
        ...
        if ($this->isBackend === true) {
            $this->setViewPath('@core/users/views/backend');
        } else {
            $this->setViewPath('@core/users/views/frontend');
        }
    }
    ...
    public function getMail()
    {
        if ($this->_mail === null) {
            ...
            $this->_mail->htmlLayout = '@core/users/mails/layouts/html';
            $this->_mail->textLayout = '@core/users/mails/layouts/text';
            $this->_mail->viewPath = '@core/users/mails/views';
    ...
    {
        return Yii::t('core/' . $category, $message, $params, $language);
    }
}
