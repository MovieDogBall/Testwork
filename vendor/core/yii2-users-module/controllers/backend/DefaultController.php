...
namespace core\users\controllers\backend;

use core\admin\components\Controller;
use core\fileapi\actions\UploadAction as FileAPIUpload;
use core\users\models\backend\User;
use core\users\models\backend\UserSearch;
...
class DefaultController extends Controller
{
     ...
     *
     * @return \core\users\models\backend\User User
