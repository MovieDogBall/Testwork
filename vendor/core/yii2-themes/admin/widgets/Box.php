...
namespace core\themes\admin\widgets;
...
/**
 * Class Box
 * @package core\themes\admin\widgets
 * Theme Box widget.
 */
    ...
    protected function initButtons()
    {
        if (!isset($this->buttons['create'])) {
            $this->buttons['create'] = [
                ...
                'options' => [
                    'class' => 'btn-default',
                    'title' => Yii::t('core/themes/admin/widgets/box', 'Create')
                ]
            ];
        }
        ...
        if (!isset($this->buttons['delete'])) {
            $this->buttons['delete'] = [
                ...
                'options' => [
                    'class' => 'btn-default',
                    'title' => Yii::t('core/themes/admin/widgets/box', 'Delete'),
                    'data-confirm' => Yii::t('core/themes/admin/widgets/box', 'Are you sure you want to delete this item?'),
                    'data-method' => 'delete'
                ]
            ];
        }
        ...
        if (!isset($this->buttons['batch-delete'])) {
            $this->buttons['batch-delete'] = [
                ...
                'options' => [
                    'id' => 'batch-delete',
                    'class' => 'btn-default',
                    'title' => Yii::t('core/themes/admin/widgets/box', 'Delete selected')
                ]
            ];
        }
        ...
        if (!isset($this->buttons['cancel'])) {
            $this->buttons['cancel'] = [
                ...
                'options' => [
                    'class' => 'btn-default',
                    'title' => Yii::t('core/themes/admin/widgets/box', 'Cancel')
                ]
            ];
        }
    }
        ...
        if (strpos($this->buttonsTemplate, '{batch-delete}') !== false && $this->grid !== null && isset($this->buttons['batch-delete'])) {
            ...
            $view->registerJs(
                "jQuery(document).on('click', '#batch-delete', function (evt) {" .
                    ...
                    "if (keys == '') {" .
                        "alert('" . Yii::t('core/themes/admin/widgets/box', 'You need to select at least one item.') . "');" .
                    "} else {" .
                        "if (confirm('" . Yii::t('core/themes/admin/widgets/box', 'Are you sure you want to delete selected items?') . "')) {" .
                            "jQuery.ajax({" .
                                "type: 'POST'," .
