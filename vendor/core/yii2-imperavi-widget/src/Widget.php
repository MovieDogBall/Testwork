 ...
 *
 * @author Vasile Crudu <neyasetwitcher@gmail.com>
 *
 * @link https://github.com/core/yii2-imperavi-widget
 * @link http://imperavi.com/redactor
 * @license https://github.com/core/yii2-imperavi-widget/blob/master/LICENSE.md
 */
class Widget extends BaseWidget
{
    /** Name of inline JavaScript package that is registered by the widget */
    const INLINE_JS_KEY = 'core/imperavi/';
    ...
    {
        if (!isset(Yii::$app->i18n->translations['core/imperavi']) && !isset(Yii::$app->i18n->translations['core/imperavi/*'])) {
            Yii::$app->i18n->translations['core/imperavi'] = [
                'class' => 'yii\i18n\PhpMessageSource',
                'basePath' => '@core/imperavi/messages',
                'forceTranslation' => true,
                'fileMap' => [
                    'core/imperavi' => 'imperavi.php'
                ]
            ];
        }
    }
