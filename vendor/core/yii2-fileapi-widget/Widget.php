 ...
 * ```
 * ...
 * echo \core\fileapi\Widget::widget([
 *     'name' => 'fileapi',
 *     'settings' => [
 *         'autoUpload' => true
 *     ]
 ...
 * ```
 * ...
 * echo $form->field($model, 'file')->widget('core\fileapi\Widget', [
 *     'settings' => [
 *         'autoUpload' => true
 *     ]
 * ]);
...
class Widget extends InputWidget
{
    ...
    {
        if (!isset(Yii::$app->i18n->translations['core/fileapi']) && !isset(Yii::$app->i18n->translations['core/*'])) {
            Yii::$app->i18n->translations['core/fileapi'] = [
                'class' => 'yii\i18n\PhpMessageSource',
                'basePath' => '@core/fileapi/messages',
                'fileMap' => [
                    'core/fileapi' => 'fileapi.php'
                ],
